...
REAL_STATEMENTS = (MP_STATEMENT, GOV_STATEMENT, PRESIDENT_STATEMENT, INTERRUPTION, SECRETARY_STATEMENT, MP_CONT, PM_STATEMENT, MINISTER_STATEMENT, STATE_SECRETARY_STATEMENT, STATEMENT, MP_ASIDE, PRESIDENT_ASIDE, PRESIDENT_NEWSPEAKER, PRESIDENT_OPEN)
